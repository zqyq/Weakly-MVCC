...
def main(args):
    ...
    # logging
    logdir = f'logs/{args.dataset}_frame/final/debug/' + datetime.datetime.today().strftime('%Y-%m-%d_%H-%M-%S') \
    ...
    if pretrain:
        ...
        #                 k in model_para and (
        #                             k.split('.')[0] == 'distence_extractor' or k.split('.')[0] == 'confidence_decoder')}
        # # model_para.update(useful_para1)
        # # model.load_state_dict(model_para)
        # print('load image classifier weight: ', img_pred_name)
        #
        # weight_pred_name = "/mnt/d/DJ/CF/logs/wildtrack_frame/final/sup_dist/2024-12-11_02-03-25/models/MultiviewDetector_epoch89.pth"
        ...
        # useful_para2 = {k: v for k, v in pretrain_para2.items() if k in model_para and (
        #             k.split('.')[0] != 'distence_extractor' and k.split('.')[0] != 'confidence_decoder')}
        #
        ...
        weight_name = "/mnt/d/DJ/CF/logs/wildtrack_frame/final/dist/2024-12-13_12-11-13/models/MAE12.99-better.pth"
