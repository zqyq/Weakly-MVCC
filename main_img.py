...
from multiview_detector.models.transformer_model import PerspTransDetector_img as PerspTransDetector
...
from multiview_detector.trainer_img import PerspectiveTrainer as PerspectiveTrainer
...
def main(args):
    ...
    # logging
    logdir = f'logs/{args.dataset}_frame/trans_2d/debug/' + datetime.datetime.today().strftime('%Y-%m-%d_%H-%M-%S') \
    ...
    if pretrain:
        ...
        weights_name = "/mnt/d/DJ/CF/ pretrain_model/model_nwpu(DM_Count).pth"
