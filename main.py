...
from multiview_detector.models.cvcs_map_homo import PerspTransDetector_homo as PerspTransDetector
...
from multiview_detector.trainer_homo import PerspectiveTrainer as PerspectiveTrainer
...
def main(args):
    ...
    # logging
    logdir = f'logs/{args.dataset}_frame/homo/' + datetime.datetime.today().strftime('%Y-%m-%d_%H-%M-%S') \
    ...
    pretrain = True
    if pretrain:
        weights_name = "/mnt/d/DJ/CF/ pretrain_model/origion/weight_pred/24-1278522.8925-better.pth"
