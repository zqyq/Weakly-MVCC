...
from multiview_detector.models.cvcs_map_depth import PerspTransDetector_max_cvcs as PerspTransDetector
...
from multiview_detector.trainer import PerspectiveTrainer as PerspectiveTrainer
...
def main(args):
    ...
    # logging
    logdir = f'logs/{args.dataset}_frame/final/dist/' + datetime.datetime.today().strftime('%Y-%m-%d_%H-%M-%S') \
    ...
    pretrain = True
    if pretrain:
        # img_pred_name = "/mnt/d/DJ/CF/logs/wildtrack_frame/final/sup_dist/2024-12-13_08-36-41/models/MultiviewDetector_epoch111.pth"
        ...
        #                 k in model_para and (k.split('.')[0] == 'match_CNN')}
        ...
        # useful_para2 = {k: v for k, v in pretrain_para2.items() if k in model_para and (k.split('.')[0] != 'match_CNN')}
        #
    ...
    if isTest:
        ...
        for epoch in tqdm.tqdm(range(1, args.epochs + 1)):
            ...
            torch.save(checkpoint, os.path.join(logdir, 'models/MultiviewDetector_epoch' + str(epoch) + '.pth'))
