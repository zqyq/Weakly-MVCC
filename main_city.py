...
from multiview_detector.datasets.frameDataset_city import frameDataset
from multiview_detector.datasets import Wildtrack, MultiviewX, Citystreet
from multiview_detector.loss.gaussian_mse import GaussianMSE

from multiview_detector.models.city_map_depth import PerspTransDetector_max_cvcs as PerspTransDetector
...
from multiview_detector.trainer_city import PerspectiveTrainer as PerspectiveTrainer
...
def main(args):
    ...
    elif 'citystreet' in args.dataset:
        data_path = os.path.expanduser('/mnt/d/data/CityStreet')
    ...
    # logging
    logdir = f'logs/{args.dataset}_frame/city/weight/' + datetime.datetime.today().strftime('%Y-%m-%d_%H-%M-%S') \
    ...
    pretrain = True
    if pretrain:
        weight_name = "/mnt/d/DJ/CF/ pretrain_model/city/70-92369611.4607-better-MAE9.27.pth"
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--dataset', type=str, default='citystreet', choices=['wildtrack', 'multiviewx'])
    ...
    # 0.001
    parser.add_argument('--lr', type=float, default=5e-7, metavar='LR', help='learning rate (default: 0.1)')
