...
def main(args):
    ...
    if 'wildtrack' in args.dataset:
        ...
        data_path = os.path.expanduser('/mnt/d/common/Datasets/Wildtrack')
    ...
    pretrain = True
    if pretrain:
        img_pred_name = "/mnt/d/common/DJ/Calibration-free/logs/wildtrack_frame/default/2024-05-15_09-30-47/models/MultiviewDetector_epoch300.pth"
        pretrain_model1 = torch.load(img_pred_name)

        model_para = model.state_dict()
        pretrain_para1 = pretrain_model1['model']
        # useful_para = {k.replace('base_pt', 'corr_encoder'): v for k, v in pretrain_para.items() if
        #                k.replace('base_pt', 'corr_encoder') in model_para}
        ...
        weight_pred_name = "/mnt/d/common/DJ/Calibration-free/logs/wildtrack_frame/homo/2024-06-29_05-42-36/models/MultiviewDetector_epoch118.pth"
        ...
        # weight_name = "/mnt/d/common/DJ/Calibration-free/logs/wildtrack_frame/debug/2024-10-29_12-02-22/models/MultiviewDetector_epoch2.pth"
